...
const Form = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.themoviedb.org/3/search/movie?api_key=f2325b7f071669430ffa93fbe85df4ad&query=${search}&language=en-US&page=1&include_adult=false`
      )
      .then((res) => {
